rm -rf *.bak
pg_dump -h 35.110.12.32 -U boarding boarding > 35_230_69_152_boarding_$(date +%d-%m-%y).bak           #user boarding and database name is "boarding"
...
find /root/db_backup  -type  f -name '*.gz' -mtime +7 -exec rm {} \;                                   #this will remove olderthan 7 daysfiles
